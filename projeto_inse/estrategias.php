					...
					<div class="row">
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								<header class="major">
									<h2>Estratégias</h2>
									<span class="byline">Utilize o formulário abaixo para cadastrar as ações estratégicas presentes no plano estratégico empresarial.</span>
								</header>
...
$(document).ready(function(){
	...
	$('#add_estrategia').click(function(e){
		...
		$('.estrategias_input').append("<table><th class='left'>Estratégia</th><th>Perspectiva do BSC</th><tr><td class='left'><textarea maxlength='255' rows='3' name='estrategia[]' value='new' style='resize: none;'></textarea><button type='button' class='button small remove' id='new'>Remover</button></td><td><input type='radio' name='perspectiva_bsc[" + count + "]' value='Econômico-Financeira'>Econômico-Financeira<br><input type='radio' name='perspectiva_bsc["+ count +"]' value='Clientes'>Clientes<br><input type='radio' name='perspectiva_bsc["+ count +"]' value='Processos Internos'>Processos Internos<br><input type='radio' name='perspectiva_bsc["+ count +"]' value='Aprendizado e Crescimento'>Aprendizado e Crescimento<br><input type='hidden' name='estid[]' value='new'></input></td></tr></table>");
		//var_dump($_GET);
		count++;
	});
